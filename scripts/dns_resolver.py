...
def run_dns_resolver(target):
    ...
    output = []
    output.append(f"SWAPTT DNS Resolver")
    ...
    elif "DNS Resolver" in ["Port Scanner Nmap", "Nmap", "Full Scan", "Small Scan"]:
    ...
    elif "DNS Resolver" == "Headers Scanner":
    ...
    elif "DNS Resolver" == "SSL/TLS Checker":
    ...
    elif "DNS Resolver" in ["XSS Exploiter", "SQLi Exploiter", "LFI/RFI Tester", "Command Injection"]:
    ...
    elif "DNS Resolver" == "WAF Detector":
    ...
    elif "DNS Resolver" == "DNS Resolver" or "DNS Resolver" == "DNS Enumeration":
    ...
    output.append("-" * 50)
    if "DNS Resolver" in ["XSS Exploiter", "SQLi Exploiter", "LFI/RFI Tester", "Command Injection"]:
...
if __name__ == "__main__":
    if len(sys.argv) > 1:
        ...
        target = "example.com"
    result = run_dns_resolver(target)
    print(result)
