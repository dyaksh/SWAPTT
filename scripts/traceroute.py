...
def run_traceroute(target):
    ...
    output = []
    output.append(f"SWAPTT Traceroute")
    ...
    elif "Traceroute" in ["Port Scanner Nmap", "Nmap", "Full Scan", "Small Scan"]:
    ...
    elif "Traceroute" == "Headers Scanner":
    ...
    elif "Traceroute" == "SSL/TLS Checker":
    ...
    elif "Traceroute" in ["XSS Exploiter", "SQLi Exploiter", "LFI/RFI Tester", "Command Injection"]:
    ...
    elif "Traceroute" == "DNS Resolver" or "Traceroute" == "DNS Enumeration":
    ...
    output.append("-" * 50)
    if "Traceroute" in ["XSS Exploiter", "SQLi Exploiter", "LFI/RFI Tester", "Command Injection"]:
