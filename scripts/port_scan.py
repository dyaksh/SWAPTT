#!/usr/bin/env python3
# Port Scanner Nmap Script for SWAPTT
import sys
import time
import random
import re
...
def run_port_scan(target):
    print(f"Running Port Scanner Nmap on {target}")
    print("Initializing...")
    time.sleep(1)
    ...
    output = []
    output.append(f"SWAPTT Port Scanner Nmap")
    ...
    elif "Port Scanner Nmap" == "IP Lookup":
    ...
    elif "Port Scanner Nmap" in ["Port Scanner Nmap", "Nmap", "Full Scan", "Small Scan"]:
    ...
    elif "Port Scanner Nmap" == "Headers Scanner":
    ...
    elif "Port Scanner Nmap" == "SSL/TLS Checker":
    ...
    elif "Port Scanner Nmap" in ["XSS Exploiter", "SQLi Exploiter", "LFI/RFI Tester", "Command Injection"]:
    ...
    elif "Port Scanner Nmap" == "WAF Detector":
    ...
    elif "Port Scanner Nmap" == "DNS Resolver" or "Port Scanner Nmap" == "DNS Enumeration":
    ...
    output.append("-" * 50)
    if "Port Scanner Nmap" in ["XSS Exploiter", "SQLi Exploiter", "LFI/RFI Tester", "Command Injection"]:
