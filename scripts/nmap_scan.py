...
def run_nmap_scan(target):
    ...
    elif "Nmap" in ["Port Scanner Nmap", "Nmap", "Full Scan", "Small Scan"]:
    ...
    elif "Nmap" in ["XSS Exploiter", "SQLi Exploiter", "LFI/RFI Tester", "Command Injection"]:
    ...
    elif "Nmap" == "DNS Resolver" or "Nmap" == "DNS Enumeration":
    ...
    output.append("-" * 50)
    if "Nmap" in ["XSS Exploiter", "SQLi Exploiter", "LFI/RFI Tester", "Command Injection"]:
