...
def run_url_fuzzer(target):
    print(f"Running URL Fuzzer on {target}")
    print("Initializing...")
    time.sleep(1)
    ...
    output = []
    output.append(f"SWAPTT URL Fuzzer")
    ...
    elif "URL Fuzzer" in ["Port Scanner Nmap", "Nmap", "Full Scan", "Small Scan"]:
    ...
    elif "URL Fuzzer" == "Headers Scanner":
    ...
    elif "URL Fuzzer" == "SSL/TLS Checker":
    ...
    elif "URL Fuzzer" in ["XSS Exploiter", "SQLi Exploiter", "LFI/RFI Tester", "Command Injection"]:
    ...
    elif "URL Fuzzer" == "DNS Resolver" or "URL Fuzzer" == "DNS Enumeration":
    ...
    output.append("-" * 50)
    if "URL Fuzzer" in ["XSS Exploiter", "SQLi Exploiter", "LFI/RFI Tester", "Command Injection"]:
