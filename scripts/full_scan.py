...
def run_full_scan(target):
    ...
    output = []
    output.append(f"SWAPTT Full Scan")
    ...
    elif "Full Scan" in ["Port Scanner Nmap", "Nmap", "Full Scan", "Small Scan"]:
    ...
    elif "Full Scan" == "Headers Scanner":
    ...
    elif "Full Scan" == "SSL/TLS Checker":
    ...
    elif "Full Scan" in ["XSS Exploiter", "SQLi Exploiter", "LFI/RFI Tester", "Command Injection"]:
    ...
    elif "Full Scan" == "DNS Resolver" or "Full Scan" == "DNS Enumeration":
    ...
    output.append("-" * 50)
    if "Full Scan" in ["XSS Exploiter", "SQLi Exploiter", "LFI/RFI Tester", "Command Injection"]:
