#!/usr/bin/env python3
# Network Scan Script for SWAPTT
import sys
import time
import random
import re
...
def run_network_scan(target):
    ...
    output = []
    output.append(f"SWAPTT Network Scan")
    ...
    elif "Network Scan" in ["Port Scanner Nmap", "Nmap", "Full Scan", "Small Scan"]:
    ...
    elif "Network Scan" == "Headers Scanner":
    ...
    elif "Network Scan" == "SSL/TLS Checker":
    ...
    elif "Network Scan" in ["XSS Exploiter", "SQLi Exploiter", "LFI/RFI Tester", "Command Injection"]:
    ...
    elif "Network Scan" == "WAF Detector":
    ...
    elif "Network Scan" == "DNS Resolver" or "Network Scan" == "DNS Enumeration":
    ...
    output.append("-" * 50)
    if "Network Scan" in ["XSS Exploiter", "SQLi Exploiter", "LFI/RFI Tester", "Command Injection"]:
