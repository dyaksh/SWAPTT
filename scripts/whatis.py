...
def run_whatis(target):
    print(f"Running WHATIS on {target}")
    print("Initializing...")
    time.sleep(1)
    ...
    elif "WHATIS" in ["Port Scanner Nmap", "Nmap", "Full Scan", "Small Scan"]:
    ...
    elif "WHATIS" in ["XSS Exploiter", "SQLi Exploiter", "LFI/RFI Tester", "Command Injection"]:
    ...
    elif "WHATIS" == "DNS Resolver" or "WHATIS" == "DNS Enumeration":
    ...
    output.append("-" * 50)
    if "WHATIS" in ["XSS Exploiter", "SQLi Exploiter", "LFI/RFI Tester", "Command Injection"]:
