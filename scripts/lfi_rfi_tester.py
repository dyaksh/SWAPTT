...
def run_lfi_rfi_tester(target):
    ...
    output = []
    output.append(f"SWAPTT LFI/RFI Tester")
    ...
    elif "LFI/RFI Tester" in ["Port Scanner Nmap", "Nmap", "Full Scan", "Small Scan"]:
    ...
    elif "LFI/RFI Tester" == "Headers Scanner":
    ...
    elif "LFI/RFI Tester" == "SSL/TLS Checker":
    ...
    elif "LFI/RFI Tester" in ["XSS Exploiter", "SQLi Exploiter", "LFI/RFI Tester", "Command Injection"]:
    ...
    elif "LFI/RFI Tester" == "WAF Detector":
    ...
    elif "LFI/RFI Tester" == "DNS Resolver" or "LFI/RFI Tester" == "DNS Enumeration":
    ...
    output.append("-" * 50)
    if "LFI/RFI Tester" in ["XSS Exploiter", "SQLi Exploiter", "LFI/RFI Tester", "Command Injection"]:
...
if __name__ == "__main__":
    if len(sys.argv) > 1:
        ...
        target = "example.com"
    result = run_lfi_rfi_tester(target)
    print(result)
