...
def run_ping_sweep(target):
    print(f"Running Ping Sweep on {target}")
    print("Initializing...")
    time.sleep(1)
    ...
    output = []
    output.append(f"SWAPTT Ping Sweep")
    ...
    elif "Ping Sweep" in ["Port Scanner Nmap", "Nmap", "Full Scan", "Small Scan"]:
    ...
    elif "Ping Sweep" == "Headers Scanner":
    ...
    elif "Ping Sweep" == "SSL/TLS Checker":
    ...
    elif "Ping Sweep" in ["XSS Exploiter", "SQLi Exploiter", "LFI/RFI Tester", "Command Injection"]:
    ...
    elif "Ping Sweep" == "DNS Resolver" or "Ping Sweep" == "DNS Enumeration":
    ...
    output.append("-" * 50)
    if "Ping Sweep" in ["XSS Exploiter", "SQLi Exploiter", "LFI/RFI Tester", "Command Injection"]:
