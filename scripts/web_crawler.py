...
def run_web_crawler(target):
    print(f"Running Web Crawler on {target}")
    print("Initializing...")
    time.sleep(1)
    ...
    output = []
    output.append(f"SWAPTT Web Crawler")
    ...
    elif "Web Crawler" in ["Port Scanner Nmap", "Nmap", "Full Scan", "Small Scan"]:
    ...
    elif "Web Crawler" == "Headers Scanner":
    ...
    elif "Web Crawler" == "SSL/TLS Checker":
    ...
    elif "Web Crawler" in ["XSS Exploiter", "SQLi Exploiter", "LFI/RFI Tester", "Command Injection"]:
    ...
    elif "Web Crawler" == "DNS Resolver" or "Web Crawler" == "DNS Enumeration":
    ...
    output.append("-" * 50)
    if "Web Crawler" in ["XSS Exploiter", "SQLi Exploiter", "LFI/RFI Tester", "Command Injection"]:
